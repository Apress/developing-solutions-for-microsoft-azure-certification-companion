    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                try
                {
                    var anExistingSubscription = await adminClient.GetSubscriptionAsync(_sbTopicName, _sbSubscriptionAllMovies);
                ...
                try
                {
                    var anExistingSubscription = await adminClient.GetSubscriptionAsync(_sbTopicName, _sbSubscriptionFamilyMovies);
                    subscriptionExists = anExistingSubscription is not null;
